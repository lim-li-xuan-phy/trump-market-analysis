...
g++ -O3 -std=c++17 event_study_engine.cpp -o event_study_engine.exe -lstdc++fs -lpq -lws2_32 -lsecur32
if %ERRORLEVEL% NEQ 0 (
...
g++ -O3 -std=c++17 backtester.cpp -o backtester.exe -lstdc++fs -lpq -lws2_32 -lsecur32
if %ERRORLEVEL% NEQ 0 (
